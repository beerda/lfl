...
[![R-CMD-check](https://github.com/beerda/lfl/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/beerda/lfl/actions/workflows/R-CMD-check.yaml)
...
For complete documentation, please visit the [package website](https://beerda.github.io/lfl/).

The original academic article describing the package is also [available as a vignette](https://github.com/beerda/lfl/blob/master/vignettes/main.pdf).
